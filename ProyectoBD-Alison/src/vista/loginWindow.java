...
private void authentication() {
    boolean verify = ConnectDB.verifyUserPassword(user, password);
    if (verify) {
        JOptionPane.showMessageDialog(this, "Credenciales correctas", "Autenticación exitosa", JOptionPane.INFORMATION_MESSAGE);
    } else {
